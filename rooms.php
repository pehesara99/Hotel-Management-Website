...
<head>
    ...
    <meta name="keywords" content="DELUXE, unica, creative, html">
...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="offcanvas__widget">
            <ul>
                <li><span class="icon_pin_alt"></span> 140 Sir James Pieris Mawatha Colombo,SL</li>
                ...
                <div class="row">
                    <div class="col-lg-7">
                        <ul class="header__top__widget">
                            <li><span class="icon_pin_alt"></span> 140 Sir James Pieris Mawatha Colombo,SL</li>
                            <li><span class="icon_phone"></span>  +94 76 333 5230</li>
                        </ul>
                    </div>
                    <div class="col-lg-5">
