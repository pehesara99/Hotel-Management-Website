...
<form class="w3-container" action="php/newBooking.php" method="POST">
  <label class="w3-text-teal"><b>Date</b></label>
  <input class="w3-input w3-border w3-light-grey" name="date"type="date">

  <label class="w3-text-teal"><b>Room</b></label>
        <select class="w3-select" name="room">
            <option value="" disabled selected>Choose your option</option>
            <?php include "php/getRoomList.php" ?> 
        </select>

  <label class="w3-text-teal"><b>Adults</b></label>
  <input class="w3-input w3-border w3-light-grey"name="adult" type="text">

  <label class="w3-text-teal"><b> Children</b></label>
  <input class="w3-input w3-border w3-light-grey"name="child" type="text">

  <label class="w3-text-teal"><b>Status</b></label>
        <select class="w3-select" name="status">
            <option value="" disabled selected>Choose your option</option>
            <option value="ARRIVED">Arrived</option>
            <option value="KEY CARD TAKEN">Key Card Taken</option>
            <option value="PAYMENT COMPLEATED">Payment Compleated</option>
